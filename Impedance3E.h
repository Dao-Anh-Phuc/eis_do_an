...
*****************************************************************************/
#ifndef _IMPEDANCE3E_H_
#define _IMPEDANCE3E_H_
...
/* Private variables for internal usage */
  ...
  ///
  BoolFlag IMP3EInited;                       /* If the program run firstly, generated sequence commands */
...
#define IMP3ECTRL_START          0
#define IMP3ECTRL_STOPNOW        1
#define IMP3ECTRL_STOPSYNC       2
#define IMP3ECTRL_GETFREQ        3   /* Get Current frequency of returned data from ISR */
#define IMP3ECTRL_SHUTDOWN       4   /* Note: shutdown here means turn off everything and put AFE to hibernate mode. The word 'SHUT DOWN' is only used here. */
